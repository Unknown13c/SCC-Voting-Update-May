      ...
      ?> <br><br>
            <div class="panel panel-default">
                ...
                <ul class="nav nav-pills">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="bscrim.php">Voted <?php echo $count1['total']?></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="bscrim_unvoted.php">Unvoted <?php echo $count2['total']?></a>
                </li>
                </ul>
                </div>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <?php 
                                    require 'dbcon.php';
                                    $bool = false;
                                    $query = $conn->query("SELECT * FROM voters WHERE department='BSCRIM' and status='Unvoted' and status1=''");
